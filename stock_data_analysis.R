...
# main focus - scrapping and analyzing stock data
# secondary theme - irregularly spaced datasets

# preprocessing
# egual amount od observations
#converting irregular xts to a regular ts


# connecting to yahoo finance and fetching data
